...
import horses from "@/images/articles/mongolia/horses.JPG"
import race from "@/images/articles/mongolia/horse-race.JPG"
import airag from "@/images/articles/mongolia/airag.JPG"
import naadam from "@/images/articles/mongolia/naadam.JPG"

export const article = {
  author: 'Marvin van Stegen',
  date: '2025-11-30',
  title: 'Goats, Ger, and Sunburn - Part 1',
  description: "Experience Mongolia's legendary Naadam Festival through a traveler's eyes. From tire-loving goats blocking dusty roads to child jockeys racing horses across the steppe, discover what makes attending Naadam near Ulaanbaatar unforgettable, and why you need sunscreen in Mongolia.",
  tags: ['travel', 'mongolia'],
  keywords: ['Naadam Festival', 'Mongolia travel', 'Khui Doloon Khudag', 'Mongolian horse racing', 'Ulaanbaatar', 'child jockeys', 'airag', 'fermented horse milk', 'nomadic culture'],
}
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: `${SITE_URL}/articles/mongolia-2025-part-1`,
  },
  twitter: {
    card: 'summary',
    creator: '@vinmarcodes',
  ...
  alternates: {
    canonical: `${SITE_URL}/articles/mongolia-2025-part-1`,
  },
}
...
<Image src={naadam} alt="Naadam Festival grounds at Khui Doloon Khudag outside Ulaanbaatar" />
...
<Image src={horses} alt="Two Mongolian horses during Naadam celebrations" />
...
<Image src={airag} alt="Traditional Mongolian airag (fermented horse milk) served in leather skin" />
...
<Image src={race} alt="Waiting for horse race to finish at Naadam Festival Mongolia" />
...
Next up: [running through Ulaanbaatar to catch a bus](/articles/mongolia-2025-part-2).
