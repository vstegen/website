...
export const article = {
  ...
  description: "Experience Mongolia's legendary Naadam Festival through a traveler's eyes. From tire-loving goats blocking dusty roads to child jockeys racing horses across the steppe, discover what makes attending Naadam near Ulaanbaatar unforgettable. Plus: why you need sunscreen in Mongolia.",
