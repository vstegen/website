      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Marvin, a software engineer based in Tokyo, Japan. I want to
            build software empowering regular people and making their life
            easier. All while exploring the world.
          </p>
