...
const projects: {
  ...
  },
  {
    name: 'ttv',
    description:
      'Small CLI utility that allows watching Twitch.tv streams and managing strictly local follows',
    link: { href: 'https://github.com/vstegen/ttv', label: 'ttv' },
  },
  {
    name: 'dotfiles',
    description:
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-md ring-1 shadow-zinc-800/5 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
        <CodeIcon className="h-8 w-8 text-zinc-400 dark:text-zinc-500" />
      </div>
...
export default function Projects() {
  return (
    <SimpleLayout
      ...
      intro="A collection of all the things I've worked on over the years."
    >
      {projects.length === 0 ? (
        <EmptyState />
      ) : (
